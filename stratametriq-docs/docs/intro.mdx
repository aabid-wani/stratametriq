...
1. **Install from VSIX:** Open VS Code, press `Ctrl+Shift+P` (or `Cmd+Shift+P`), type and select **`Extensions: Install from VSIX...`**, and choose the bundled extension package (**`stratometriq-extension-1.3.0.vsix`**).
